...
> [!NOTE] [PT] Essa versão do writeup está em inglês. Clique [aqui](%28PT%20-%20BR%29%20RootMe%20Writeup) para ir para a versão em português.

> [!Warning] [EN] This writeup is unfinished. I'm still working to translate everything, sorry for the inconvenience
## Sumário

Github link for this writeup: 
...
![rootme_page](imagens_rootme/rootme_page.png)
...
![rootme_page_srcode](imagens_rootme/rootme_page_srcode.png)
...
![rootme_gobuster](imagens_rootme/rootme_gobuster.png)
...
![rootme_panel](imagens_rootme/rootme_panel.png)
...
![rootme_panel_upload_success](imagens_rootme/rootme_panel_upload_success.png)

e ao clicar em ver, fui direcionado para a página de uploads, de forma mais específica, para o arquivo que eu havia enviado.

![rootme_uploads_html](imagens_rootme/rootme_uploads_html.png)
...
![rootme_revshell](imagens_rootme/rootme_revshell.png)

Coloquei o IP da vpn do meu computador e a porta corretos e fiz o upload para o sistema:

![rootme_php_not_allowed](imagens_rootme/rootme_php_not_allowed.png)
...
![netcat](imagens_rootme/rootme_netcat.png)
...
![netcat ls](imagens_rootme/rootme_ls_var.png)
...
![user.txt](imagens_rootme/rootme_find_usertxt.png)
...
![rootme_sudo-l](imagens_rootme/rootme_sudo-l.png)
...
![rootme_perms](imagens_rootme/rootme_perms.png)
...
![rootme_root](imagens_rootme/rootme_root.png)
